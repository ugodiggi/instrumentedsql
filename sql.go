...
// Replacement for "github.com/kr/pretty Sprint since I don't want the external dependency.
func prettySprint(args interface{}) string {
...
func (c wrappedConn) ExecContext(ctx context.Context, query string, args []driver.NamedValue) (r driver.Result, err error) {
	...
	span.SetLabel("args", prettySprint(args))
	defer func() {
		span.SetLabel("err", fmt.Sprint(err))
		span.Finish()
		c.Log(ctx, "sql-conn-exec", "query", query, "args", prettySprint(args), "err", err)
	}()
...
func (c wrappedConn) QueryContext(ctx context.Context, query string, args []driver.NamedValue) (rows driver.Rows, err error) {
	...
	defer func() {
		span.SetLabel("err", fmt.Sprint(err))
		span.Finish()
		c.Log(ctx, "sql-conn-query", "query", query, "args", prettySprint(args), "err", err)
	}()
...
func (s wrappedStmt) Exec(args []driver.Value) (res driver.Result, err error) {
	...
	defer func() {
		span.SetLabel("err", fmt.Sprint(err))
		span.Finish()
		s.Log(s.ctx, "sql-stmt-exec", "query", s.query, "args", prettySprint(args), "err", err)
	}()
...
func (s wrappedStmt) Query(args []driver.Value) (rows driver.Rows, err error) {
	...
	defer func() {
		span.SetLabel("err", fmt.Sprint(err))
		span.Finish()
		s.Log(s.ctx, "sql-stmt-query", "query", s.query, "args", prettySprint(args), "err", err)
	}()
...
func (s wrappedStmt) ExecContext(ctx context.Context, args []driver.NamedValue) (res driver.Result, err error) {
	...
	defer func() {
		span.SetLabel("err", fmt.Sprint(err))
		span.Finish()
		s.Log(ctx, "sql-stmt-exec", "query", s.query, "args", prettySprint(args), "err", err)
	}()
...
func (s wrappedStmt) QueryContext(ctx context.Context, args []driver.NamedValue) (rows driver.Rows, err error) {
	...
	defer func() {
		span.SetLabel("err", fmt.Sprint(err))
		span.Finish()
		s.Log(ctx, "sql-stmt-query", "query", s.query, "args", prettySprint(args), "err", err)
	}()
